...
export const memory = {
  ...
  text: "What we have always taken care for 10 years is always prioritizing the comfort of our users. So, do not forget our quality.",
  img: memoryimg,
  experience: [
    { number: "10", title: "Year Experience" },
    { number: "400", title: "Year Collaboration" },
    { number: "30k+", title: "Happy Customers" },
  ],
};
...
export const bannerAPI = {
  ...
  text: "Whishlist Curated By Travigo.",
  imgSrc: banner,
